                      ...
                      child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                FlutterLogo(
                                    size: (uni_height * uni_width) / 3840.0),
                                Padding(
                                  padding: EdgeInsets.only(
                                      left: uni_width / 90,
                                      right: uni_width / 27.692),
                                  child: ClipOval(
                                    child: Container(
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding:
                                          EdgeInsets.only(top: uni_height / 64),
                                      child: Text(
                                        'X',
                                        style: TextStyle(
                                            fontStyle: FontStyle.italic),
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                      left: uni_width / 27.692,
                                      right: uni_width / 14.4),
                                  child: ClipOval(
                                    child: Container(
                                      height: uni_height / 6.4,
                                      width: uni_width / 180,
                                      ...
                                      child: (data != null)
                                          ? Row(children: <Widget>[
                                              (data['NormalTrophies'] >= 1)
                                                  ...
                                                  : Container(),
                                              (data['NormalTrophies'] >= 2)
                                                  ? Image(
                                                      image: AssetImage(
                                                          'images/trophies/silver.png'),
                                                      width: uni_width / 15,
                                                      height: uni_height / 24,
                                                    )
                                                  : Container(),
                                              (data['NormalTrophies'] == 3)
                                                  ? Image(
                                                      image: AssetImage(
                                                          'images/trophies/gold.png'),
                                                      width: uni_width / 15,
                                                      height: uni_height / 24,
                                                    )
                                                  : Container(),
